        ...
        <div className="container grid lg:grid-cols-2 gap-8 items-center min-h-[88vh] py-16 lg:py-0">
          ...
          >
            ...
            <motion.div variants={fadeUp} className="mt-8 flex flex-wrap gap-4">
              <Link href="/chapters">
                <span className="group inline-flex items-center gap-2 px-7 py-3.5 rounded-xl bg-[#1e3a5f] text-white font-semibold text-sm hover:bg-[#162d4a] transition-all shadow-lg shadow-[#1e3a5f]/20 hover:shadow-xl hover:shadow-[#1e3a5f]/25 cursor-pointer">
                  <BookOpen size={18} />
                  Explore Chapters
                  <ArrowRight
                    size={16}
